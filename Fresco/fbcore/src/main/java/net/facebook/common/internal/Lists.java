...
/**
 * Static utility methods pertaining to {@link java.util.List} instances. Also see this
...
public final class Lists {
     ...
     * <p/>
     * <p><b>Note:</b> if mutability is not required and the elements are
     * non-null, use {@link ImmutableList#copyOf(java.util.Iterator)} instead.
     *
     * @param elements the elements that the list should contain, in order
     * @return a new {@code ArrayList} containing those elements
     */
     ...
     * {@link java.util.ArrayList#ArrayList(int)}.
     * <p/>
     * <p><b>Note:</b> if you know the exact size your list will be, consider
     * using a fixed-size list ({@link java.util.Arrays#asList(Object[])}) or an {@link
     * ImmutableList} instead of a growable {@link java.util.ArrayList}.
     * <p/>
     ...
     *
     * @param estimatedSize an estimate of the eventual {@link java.util.List#size()} of
     *                      the new list
