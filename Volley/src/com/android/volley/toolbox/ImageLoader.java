...
public class ImageLoader {
    ...
    public ImageContainer get(String requestUrl, ImageListener imageListener,
        ...
        if (requestUrl.trim().toLowerCase().startsWith("file")) {
            try {
                File f = new File(new URI(requestUrl));
                if (f.exists() && f.canRead()) {
                    cachedBitmap = BitmapFactory.decodeFile(f.getAbsolutePath());
            ...
            return null;
        } else if (requestUrl.trim().toLowerCase().startsWith("http")) {
