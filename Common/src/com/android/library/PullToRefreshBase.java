...
import com.android.library.internal.FlipLoadingLayout;
import com.android.library.internal.LoadingLayout;
import com.android.library.internal.RotateLoadingLayout;
import com.android.library.internal.Utils;
import com.android.library.internal.ViewCompat;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
	...
	/**
	 * Called when the UI has been to be updated to be in the
	 * {@link com.android.library.PullToRefreshBase.State#RESET} state.
	 */
	...
	private void init(Context context, AttributeSet attrs) {
		...
		// Styleables from XML
		TypedArray a = context.obtainStyledAttributes(attrs, com.android.common.R.styleable.PullToRefresh);

		if (a.hasValue(com.android.common.R.styleable.PullToRefresh_ptrMode)) {
			mMode = Mode.mapIntToValue(a.getInteger(com.android.common.R.styleable.PullToRefresh_ptrMode, 0));
		}

		if (a.hasValue(com.android.common.R.styleable.PullToRefresh_ptrAnimationStyle)) {
			mLoadingAnimationStyle = AnimationStyle.mapIntToValue(a.getInteger(
                    com.android.common.R.styleable.PullToRefresh_ptrAnimationStyle, 0));
		}
		 ...
		 * Styleables from XML
		 */
		if (a.hasValue(com.android.common.R.styleable.PullToRefresh_ptrRefreshableViewBackground)) {
			Drawable background = a.getDrawable(com.android.common.R.styleable.PullToRefresh_ptrRefreshableViewBackground);
			if (null != background) {
				mRefreshableView.setBackgroundDrawable(background);
			}
		} else if (a.hasValue(com.android.common.R.styleable.PullToRefresh_ptrAdapterViewBackground)) {
			Utils.warnDeprecation("ptrAdapterViewBackground", "ptrRefreshableViewBackground");
			Drawable background = a.getDrawable(com.android.common.R.styleable.PullToRefresh_ptrAdapterViewBackground);
			if (null != background) {
				mRefreshableView.setBackgroundDrawable(background);
			}
		}

		if (a.hasValue(com.android.common.R.styleable.PullToRefresh_ptrOverScroll)) {
			mOverScrollEnabled = a.getBoolean(com.android.common.R.styleable.PullToRefresh_ptrOverScroll, true);
		}

		if (a.hasValue(com.android.common.R.styleable.PullToRefresh_ptrScrollingWhileRefreshingEnabled)) {
			mScrollingWhileRefreshingEnabled = a.getBoolean(
					com.android.common.R.styleable.PullToRefresh_ptrScrollingWhileRefreshingEnabled, false);
		}
	...
	public static enum Mode {
		 ...
		 * {@link com.android.library.PullToRefreshBase#setRefreshing() setRefreshing()}.
		 */
