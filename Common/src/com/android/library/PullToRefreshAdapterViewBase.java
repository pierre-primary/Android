...
import com.android.library.internal.EmptyViewMethodAccessor;
import com.android.library.internal.IndicatorLayout;
...
public abstract class PullToRefreshAdapterViewBase<T extends AbsListView> extends PullToRefreshBase<T> implements
	 ...
	 * {@link com.android.library.PullToRefreshBase.Mode#PULL_FROM_START}. The default value is <var>true</var> if
	 ...
	 * a state where a Pull-to-Refresh can happen. An example of this state is
	 * when the Adapter View is scrolled to the top and the mode is set to
	 * {@link com.android.library.PullToRefreshBase.Mode#PULL_FROM_START}
	 * 
	...
	protected void handleStyledAttributes(TypedArray a) {
		...
		mShowIndicator = a.getBoolean(com.android.common.R.styleable.PullToRefresh_ptrShowIndicator, !isPullToRefreshOverScrollEnabled());
	}
	...
	private void addIndicatorViews() {
		...
		if (mode.showHeaderLoadingLayout() && null == mIndicatorIvTop) {
			...
			params.rightMargin = getResources().getDimensionPixelSize(com.android.common.R.dimen.indicator_right_padding);
