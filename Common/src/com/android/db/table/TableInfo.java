 ...
 */
package com.android.db.table;

import com.android.util.ClassUtils;
import com.android.util.DbException;
import com.android.util.FieldUtils;
...
public class TableInfo {
    ...
    public static TableInfo get(Class<?> clazz) throws DbException {
        if (clazz == null)
