...
import com.android.db.sqlite.CursorUtils;
import com.android.db.sqlite.DbModel;
import com.android.db.sqlite.ManyToOneLazyLoader;
import com.android.db.sqlite.OneToManyLazyLoader;
import com.android.db.sqlite.SqlBuilder;
import com.android.db.sqlite.SqlInfo;
import com.android.db.table.KeyValue;
import com.android.db.table.ManyToOne;
import com.android.db.table.OneToMany;
import com.android.db.table.TableInfo;
import com.android.util.DbException;
 ...
 * @author cxd
 */
public class CFrameDb {

    private static final String TAG = "FinalDb";

    private static HashMap<String, CFrameDb> daoMap = new HashMap<String, CFrameDb>();

    private SQLiteDatabase db;
    private DaoConfig config;

    private CFrameDb(DaoConfig config) throws DbException {
        if (config == null)
    ...
    private synchronized static CFrameDb getInstance(DaoConfig daoConfig) {
        CFrameDb dao = daoMap.get(daoConfig.getDbName());
        if (dao == null) {
            try {
                dao = new CFrameDb(daoConfig);
            } catch (DbException e) {
     ...
     * @param context
     */
    public static CFrameDb create(Context context) {
     ...
     */
    public static CFrameDb create(Context context, boolean isDebug) {
        DaoConfig config = new DaoConfig();
        config.setContext(context);
     ...
     * @param dbName  数据库名称
     */
    public static CFrameDb create(Context context, String dbName) {
        DaoConfig config = new DaoConfig();
        config.setContext(context);
     ...
     */
    public static CFrameDb create(Context context, String dbName, boolean isDebug) {
        DaoConfig config = new DaoConfig();
        config.setContext(context);
        config.setDbName(dbName);
        config.setDebug(isDebug);
     ...
     * @param dbName  数据库名称
     */
    public static CFrameDb create(Context context, String targetDirectory,
                                  String dbName) {
        DaoConfig config = new DaoConfig();
        config.setContext(context);
        config.setDbName(dbName);
     ...
     * @return
     */
    public static CFrameDb create(DaoConfig daoConfig) {
     ...
     *
     * @param entity
     * @throws com.android.util.DbException
     */
     ...
     * @throws com.android.util.DbException
     */
    public boolean saveBindId(Object entity) throws DbException {
        checkTableExist(entity.getClass());
     ...
     * @throws com.android.util.DbException
     */
    public void update(Object entity, String strWhere) throws DbException {
        checkTableExist(entity.getClass());
     ...
     * @throws com.android.util.DbException
     */
    public void deleteById(Class<?> clazz, Object id) throws DbException {
     ...
     * @throws com.android.util.DbException
     */
    public void deleteByWhere(Class<?> clazz, String strWhere) throws DbException {
        checkTableExist(clazz);
     ...
     * @throws com.android.util.DbException
     */
    public <T> T findById(Object id, Class<T> clazz) throws DbException {
        checkTableExist(clazz);
     ...
     * @throws com.android.util.DbException
     */
    public <T> T findWithManyToOneById(Object id, Class<T> clazz) throws DbException {
        checkTableExist(clazz);
    ...
    public <T> T findWithManyToOneById(Object id, Class<T> clazz,
                                       Class<?>... findClass) throws DbException {
        checkTableExist(clazz);
        String sql = SqlBuilder.getSelectSQL(clazz, id);
        debugSql(sql);
        DbModel dbModel = findDbModelBySQL(sql);
     ...
     * @throws com.android.util.DbException
     */
    public <T> T findWithOneToManyById(Object id, Class<T> clazz) throws DbException {
        checkTableExist(clazz);
        String sql = SqlBuilder.getSelectSQL(clazz, id);
        debugSql(sql);
        DbModel dbModel = findDbModelBySQL(sql);
     ...
     * @throws com.android.util.DbException
     */
    public <T> List<T> findAll(Class<T> clazz, String orderBy) throws DbException {
        checkTableExist(clazz);
        return findAllBySql(clazz, SqlBuilder.getSelectSQL(clazz)
                + " ORDER BY " + orderBy);
    }
     ...
     * @throws com.android.util.DbException
     */
    public <T> List<T> findAllByWhere(Class<T> clazz, String strWhere) throws DbException {
        checkTableExist(clazz);
     ...
     */
    public <T> List<T> findAllBySql(Class<T> clazz, String strSQL) throws SQLException, DbException {
        checkTableExist(clazz);
        debugSql(strSQL);
    ...
    private void checkTableExist(Class<?> clazz) throws SQLException, DbException {
    ...
    public static class DaoConfig {
        ...
        private String mDbName = "CFrame.db"; // 数据库名字
    ...
    private SQLiteDatabase createDbFileOnSDCard(String sdcardPath,
                                                String dbfilename) throws DbException {
