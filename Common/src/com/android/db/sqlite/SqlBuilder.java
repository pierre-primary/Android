...
import com.android.db.table.Id;
...
public class SqlBuilder {
     ...
     */
    public static SqlInfo buildInsertSql(Object entity) throws DbException {
    ...
    public static List<KeyValue> getSaveKeyValueListByEntity(Object entity) throws DbException {
    ...
    public static SqlInfo buildDeleteSql(Object entity) throws DbException {
        TableInfo table = TableInfo.get(entity.getClass());
    ...
    public static SqlInfo buildDeleteSql(Class<?> clazz, Object idValue) throws DbException {
     ...
     * @throws com.android.util.DbException
     */
    public static String buildDeleteSql(Class<?> clazz, String strWhere) throws DbException {
        TableInfo table = TableInfo.get(clazz);
        StringBuffer strSQL = new StringBuffer(getDeleteSqlBytableName(table.getTableName()));
    ...
    public static String getSelectSQL(Class<?> clazz, Object idValue) throws DbException {
        TableInfo table = TableInfo.get(clazz);
    ...
    public static SqlInfo getSelectSqlAsSqlInfo(Class<?> clazz, Object idValue) throws DbException {
        TableInfo table = TableInfo.get(clazz);
    ...
    public static String getSelectSQL(Class<?> clazz) throws DbException {
        return getSelectSqlByTableName(TableInfo.get(clazz).getTableName());
    }

    public static String getSelectSQLByWhere(Class<?> clazz, String strWhere) throws DbException {
        TableInfo table = TableInfo.get(clazz);
    ...
    public static SqlInfo getUpdateSqlAsSqlInfo(Object entity) throws DbException {
    ...
    public static SqlInfo getUpdateSqlAsSqlInfo(Object entity, String strWhere) throws DbException {
    ...
    public static String getCreatTableSQL(Class<?> clazz) throws DbException {
        TableInfo table = TableInfo.get(clazz);
    ...
    private static KeyValue manyToOne2KeyValue(ManyToOne many, Object entity) throws DbException {
        KeyValue kv = null;
