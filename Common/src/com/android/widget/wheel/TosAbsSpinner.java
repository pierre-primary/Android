...
public abstract class TosAbsSpinner extends TosAdapterView<SpinnerAdapter> {
    ...
    public TosAbsSpinner(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, com.android.common.R.styleable.AbsSpinner, defStyle, 0);

        CharSequence[] entries = a.getTextArray(com.android.common.R.styleable.AbsSpinner_entries);
        if (entries != null) {
    ...
    static class SavedState extends BaseSavedState {
        ...
        /**
         * Constructor called from {@link com.android.widget.wheel.TosAbsSpinner#onSaveInstanceState()}
         */
