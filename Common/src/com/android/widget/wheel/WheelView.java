...
public class WheelView extends TosGallery {
    ...
    private void initialize(Context context) {
        ...
        this.mSelectorDrawable = getContext().getResources().getDrawable(com.android.common.R.drawable.wheel_val);
        ...
        this.setBackgroundResource(com.android.common.R.drawable.wheel_bg);
