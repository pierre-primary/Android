 ...
 * <p>
 * Views given to the Gallery should use {@link com.android.widget.wheel.TosGallery.LayoutParams} as their layout parameters
 * type.
 * 
...
public class TosGallery extends TosAbsSpinner implements GestureDetector.OnGestureListener,
    ...
    public TosGallery(Context context, AttributeSet attrs) {
        this(context, attrs, com.android.common.R.attr.galleryStyle);
    }
    ...
    public TosGallery(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, com.android.common.R.styleable.Gallery, defStyle, 0);

        int index = a.getInt(com.android.common.R.styleable.Gallery_gravity, -1);
        if (index >= 0) {
            setGravity(index);
        }

        int animationDuration = a.getInt(com.android.common.R.styleable.Gallery_animationDuration, -1);
        if (animationDuration > 0) {
            setAnimationDuration(animationDuration);
        }

        int spacing = a.getDimensionPixelOffset(com.android.common.R.styleable.Gallery_spacing, 0);
        setSpacing(spacing);

        float unselectedAlpha = a.getFloat(com.android.common.R.styleable.Gallery_unselectedAlpha, 0.5f);
...
//        Logs.w("computeHorizontalScrollOffset","computeHorizontalScrollOffset" + mSelectedPosition);
        return mSelectedPosition;
...
//        Logs.w("setSelectionToCenterChildVertical " , " setSelectionToCenterChildVertical " + mSelectedChild);
        View selView = mSelectedChild;
        if (mSelectedChild == null)
            return;
//        Logs.w("setSelectionToCenterChildVertical :" ,selView + " ");
        int galleryCenter = getCenterOfGallery();
