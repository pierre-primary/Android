...
public class OutlineContainer extends FrameLayout implements Animatable {
	...
	private void init() {
		...
		mOutlinePaint.setColor(getResources().getColor(com.android.common.R.color.holo_blue));
	...
	protected void dispatchDraw(Canvas canvas) {
		...
		if (mOutlinePaint.getColor() != AnnmitionViewPager.sOutlineColor) {
			mOutlinePaint.setColor(AnnmitionViewPager.sOutlineColor);
		}
