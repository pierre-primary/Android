...
public class ClockText extends TextView {
    ...
    public ClockText(Context context, AttributeSet attrs) {
        ...
        TypedArray tArray = context.obtainStyledAttributes(attrs,
                com.android.common.R.styleable.ClockText);
        mFormat = tArray.getString(com.android.common.R.styleable.ClockText_mFormat);
        if (mFormat == null || mFormat.equals("")) {
            mFormat = "yyyy/MM/dd hh:mm:ss";
        }
        updateTime = tArray.getInt(com.android.common.R.styleable.ClockText_updateTime, 1000);
        initClock();
    }
