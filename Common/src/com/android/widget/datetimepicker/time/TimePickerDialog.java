package com.android.widget.datetimepicker.time;
/*
...
public class TimePickerDialog extends DialogFragment implements RadialPickerLayout.OnValueSelectedListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(com.android.common.R.layout.time_picker_dialog, null);
        KeyboardListener keyboardListener = new KeyboardListener();
        view.setOnKeyListener(keyboardListener);

        Resources res = getResources();
        mHourPickerDescription = res.getString(com.android.common.R.string.hour_picker_description);
        mSelectHours = res.getString(com.android.common.R.string.select_hours);
        mMinutePickerDescription = res.getString(com.android.common.R.string.minute_picker_description);
        mSelectMinutes = res.getString(com.android.common.R.string.select_minutes);
        mBlue = res.getColor(com.android.common.R.color.blue);
        mBlack = res.getColor(com.android.common.R.color.numbers_text_color);

        mHourView = (TextView) view.findViewById(com.android.common.R.id.hours);
        mHourView.setOnKeyListener(keyboardListener);
        mHourSpaceView = (TextView) view.findViewById(com.android.common.R.id.hour_space);
        mMinuteSpaceView = (TextView) view.findViewById(com.android.common.R.id.minutes_space);
        mMinuteView = (TextView) view.findViewById(com.android.common.R.id.minutes);
        mMinuteView.setOnKeyListener(keyboardListener);
        mAmPmTextView = (TextView) view.findViewById(com.android.common.R.id.ampm_label);
        ...
        mTimePicker = (RadialPickerLayout) view.findViewById(com.android.common.R.id.time_picker);
        ...
        mDoneButton = (TextView) view.findViewById(com.android.common.R.id.done_button);
        ...
        mAmPmHitspace = view.findViewById(com.android.common.R.id.ampm_hitspace);
        if (mIs24HourMode) {
            ...
            TextView separatorView = (TextView) view.findViewById(com.android.common.R.id.separator);
        ...
        mDoublePlaceholderText = res.getString(com.android.common.R.string.time_placeholder);
        mDeletedKeyFormat = res.getString(com.android.common.R.string.deleted_key);
