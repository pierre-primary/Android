...
public class AmPmCirclesView extends View {
    ...
    public void initialize(Context context, int amOrPm) {
        ...
        mWhite = res.getColor(com.android.common.R.color.white);
        mAmPmTextColor = res.getColor(com.android.common.R.color.ampm_text_color);
        mBlue = res.getColor(com.android.common.R.color.blue);
        String typefaceFamily = res.getString(com.android.common.R.string.sans_serif);
        ...
        mCircleRadiusMultiplier =
                Float.parseFloat(res.getString(com.android.common.R.string.circle_radius_multiplier));
