...
public class RadialSelectorView extends View {
    ...
    public void initialize(Context context, boolean is24HourMode, boolean hasInnerCircle,
        ...
        int blue = res.getColor(com.android.common.R.color.blue);
        ...
        if (hasInnerCircle) {
            mInnerNumbersRadiusMultiplier =
                    Float.parseFloat(res.getString(com.android.common.R.string.numbers_radius_multiplier_inner));
            mOuterNumbersRadiusMultiplier =
                    Float.parseFloat(res.getString(com.android.common.R.string.numbers_radius_multiplier_outer));
        } else {
            mNumbersRadiusMultiplier =
                    Float.parseFloat(res.getString(com.android.common.R.string.numbers_radius_multiplier_normal));
        }
        mSelectionRadiusMultiplier =
                Float.parseFloat(res.getString(com.android.common.R.string.selection_radius_multiplier));
