...
public class DatePickerDialog extends Dialog implements View.OnClickListener, DatePickerController {
    ...
    public static DatePickerDialog newInstance(Context context, OnDateSetListener onDateSetListener, int year, int month, int day) {
        return newInstance(context, onDateSetListener, year, month, day, true);
    }

    public static DatePickerDialog newInstance(Context context, OnDateSetListener onDateSetListener, int year, int month, int day, boolean vibrate) {
    ...
    public void onClick(View view) {
        tryVibrate();
        if (view.getId() == com.android.common.R.id.date_picker_year)
            setCurrentView(YEAR_VIEW);
        else if (view.getId() == com.android.common.R.id.date_picker_month_and_day)
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView(onCreateView(activity.getLayoutInflater(), null, bundle));
        activity.getWindow().setSoftInputMode(WindowManager.LayoutParams.SOFT_INPUT_STATE_ALWAYS_HIDDEN);
        mVibrator = ((Vibrator) activity.getSystemService(Context.VIBRATOR_SERVICE));//vibrator
        if (bundle != null) {
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup parent, Bundle bundle) {
        ...
        View view = layoutInflater.inflate(com.android.common.R.layout.date_picker_dialog, null);

        mDayOfWeekView = ((TextView) view.findViewById(com.android.common.R.id.date_picker_header));
        mMonthAndDayView = ((LinearLayout) view.findViewById(com.android.common.R.id.date_picker_month_and_day));
        mMonthAndDayView.setOnClickListener(this);
        mSelectedMonthTextView = ((TextView) view.findViewById(com.android.common.R.id.date_picker_month));
        mSelectedDayTextView = ((TextView) view.findViewById(com.android.common.R.id.date_picker_day));
        mYearView = ((TextView) view.findViewById(com.android.common.R.id.date_picker_year));
        ...
        mDayPickerDescription = resources.getString(com.android.common.R.string.day_picker_description);
        mSelectDay = resources.getString(com.android.common.R.string.select_day);
        mYearPickerDescription = resources.getString(com.android.common.R.string.year_picker_description);
        mSelectYear = resources.getString(com.android.common.R.string.select_year);

        mAnimator = ((AccessibleDateAnimator) view.findViewById(com.android.common.R.id.animator));
        ...
        mDoneButton = ((Button) view.findViewById(com.android.common.R.id.done));
