...
import com.android.bitmap.core.BitmapCache;
import com.android.bitmap.core.BitmapDisplayConfig;
import com.android.bitmap.core.BitmapProcess;
import com.android.bitmap.display.Displayer;
import com.android.bitmap.display.SimpleDisplayer;
import com.android.bitmap.download.Downloader;
import com.android.bitmap.download.SimpleDownloader;
...
public class CBitmap implements BitmapInterface {
    ...
    private static CBitmap mFinalBitmap;

    ////////////////////////// config method start////////////////////////////////////
    private CBitmap(Context context) {
        mContext = context;
     ...
     * @return
     */
    public static synchronized CBitmap create(Context ctx) {
        if (mFinalBitmap == null) {
            mFinalBitmap = new CBitmap(ctx.getApplicationContext());
        }
        return mFinalBitmap;
    }
     ...
     * @param bitmap
     */
    public CBitmap configLoadingImage(Bitmap bitmap) {
     ...
     * @param resId
     */
    public CBitmap configLoadingImage(int resId) {
     ...
     * @param bitmap
     */
    public CBitmap configLoadfailImage(Bitmap bitmap) {
     ...
     * @param resId
     */
    public CBitmap configLoadfailImage(int resId) {
     ...
     * @param bitmapHeight
     */
    public CBitmap configBitmapMaxHeight(int bitmapHeight) {
     ...
     * @param bitmapWidth
     */
    public CBitmap configBitmapMaxWidth(int bitmapWidth) {
     ...
     * @return
     */
    public CBitmap configDownlader(Downloader downlader) {
     ...
     * @return
     */
    public CBitmap configDisplayer(Displayer displayer) {
     ...
     * @return
     */
    public CBitmap configDiskCachePath(String strPath) {
     ...
     * @param size 缓存大小
     */
    public CBitmap configMemoryCacheSize(int size) {
     ...
     */
    public CBitmap configMemoryCachePercent(float percent) {
     ...
     * @param size
     */
    public CBitmap configDiskCacheSize(int size) {
     ...
     * @param size
     */
    public CBitmap configBitmapLoadThreadSize(int size) {
        if (size >= 1)
     ...
     * @return
     */
    public CBitmap configRecycleImmediately(boolean recycleImmediately) {
    ...
    @Override
    public void display(View view, String uri, int defaultImageResId, int errorImageResId, boolean showing) {
        if (view instanceof ImageView)
            ((ImageView) view).setImageResource(defaultImageResId);
        else
        ...
        try {
            ...
            if (view instanceof ImageView)
                ((ImageView) view).setImageResource(errorImageResId);
            else
